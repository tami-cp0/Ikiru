...
function fetchPosts () {
  ...
  $.get({
    url: `https://web-01.tamilore.tech/api/v1/posts/9/${refreshed}/${id}`,
      ...
      const post_html = `<article class="post">
                <div class="left-side">
                  <figure id="post-profile-pic">
                    <a href="/${response.username}"><img src="../static/images/anonRectangle160.png" alt="Profile picture" loading="lazy" /></a>
                  </figure>
                  <div class="thread"></div>
                </div>
                <div class="content">
                  <p class="name"><a href="/${response.username}">${ response.name }</a></p>
                  <p class="post-text">${ response.content }</p>
                  <p class="id" id="${ response.id }" style="display: none;"></p>
                  <div class="post-interaction">
                    ...
                    <div class="comment">
                      ...
                      <span><span class="comment-count">${ response.comments }</span> comments</span>
                    </div>
                    <div class="save">
                      <svg
                        class="save-button"
